...
public class RunningUpdaterTask {
	...
	public RunningUpdaterTask(Activity activity, TrackManager trackmanager) {
		...
		graphSpeed = (GraphLiveView) activity
				.findViewById(R.id.view_graphview_Speed);
		graphSteps = (GraphLiveView) activity
				.findViewById(R.id.view_graphview_Steps);
		graphHeight = (GraphLiveView) activity
				.findViewById(R.id.view_graphview_Height);
		graphDistance = (GraphLiveView) activity
				.findViewById(R.id.view_graphview_Distance);
		...
		graphSpeed.setText(activity.getResources().getString(
				R.string.graph_speed));
		graphSteps.setText(activity.getResources().getString(
				R.string.graph_steps));
		graphHeight.setText(activity.getResources().getString(
				R.string.graph_heigth));
		graphDistance.setText(activity.getResources().getString(
